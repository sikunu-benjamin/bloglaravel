...
@endif
    <img class="avatar avatar-sm mr-4" src="{{ asset(Gravatar::src($comment->commenter->email ?? $comment->guest_email)) }}" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
    <div class="media-body">
        ...
        <div class="small-2 mb-0" style="white-space: pre-wrap;">{!! $markdown->line($comment->comment) !!}</div>
