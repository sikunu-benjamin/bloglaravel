                ...
                <div class="ssg-content">
                    <div class="ssg-items ssg-items-boxed">
                        <a class="ssg-item" href="users_profile_big.html">
                            <div class="item-media" style="background-image: url({{ asset('img/avatar-brad.png') }})"></div>
                            <div class="item-name">
    ...
    <div class="layout-w">
        ...
        <div class="menu-mobile menu-activated-on-click color-scheme-dark">
            <div class="mm-logo-buttons-w">
                <a class="mm-logo" href="index.html"><img src="{{ asset('img/logo-dark.png') }}"><span>dieu a parle</span></a>
            ...
            <div class="menu-and-user">
                <div class="logged-user-w">
                    <div class="avatar-w">
                        <img alt="" src="{{ asset('img/avatar-brad.png') }}">
                    </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="btn btn-primary btn-twitter"><i class="os-icon os-icon-signs-11"></i><span>Logout</span></button>
                                </form>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="content-i">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img alt="" src="{{ isset($user->image) ? asset($user->image) : Gravatar::src($user->email) }}" width="25px">
                                                </td>
                                                <td class="text-right">
                                                    {{ $user->id }}
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="text-success" data-title="ADMINISTRATOR" data-toggle="tooltip">
                                                        @if($user->role != 'writer') admin @endif
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="cell-image-list">
                                                        <div class="cell-img" style="background-image: url({{ asset('storage/'. $post->image ) }})"></div>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="status-pill @if($post->published_at <= now()) green @else yellow @endif"  @if($post->published_at <= now()) data-title="Publié" data-toggle="tooltip" @else data-title="Il sera publié {{ $post->published_at }}" data-toggle="tooltip" @endif></div>
                                                </td>
                                                <td class="text-right">
                                                    {{ $post->comments->count() }}
                                                </td>
              ...
              -------------------->
                    <div class="floated-chat-btn">
                        <i class="os-icon os-icon-mail-07"></i><span>We are online</span>
                    </div>
